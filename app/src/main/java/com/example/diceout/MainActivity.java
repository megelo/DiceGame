...
public class MainActivity extends AppCompatActivity {
    ...
    //Field to hold the random value
    Random rand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Link instance to widgets in the activity view
        ...
        //Create ArrayList container for dice images
    ...
    public void rollDice(View v) { //After onCLick event happens it will pass view of event to this method
